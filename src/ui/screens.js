...
export function showTitle(app) {
  app.ui.innerHTML = `
    <div class="screen">
      ...
      <div class="panel" style="max-width:560px;text-align:center;font-size:14px;line-height:2">${CONTROLS_KEYBOARD_HTML}</div>
    </div>`;
...
export function showPause(app, { onResume, onRestart, onQuit }) {
  app.ui.innerHTML = `
    <div class="screen" style="background:rgba(5,8,18,0.82)">
      ...
      <div class="sub" style="margin-top:4px">${CONTROLS_KEYBOARD_HTML}</div>
    </div>`;
